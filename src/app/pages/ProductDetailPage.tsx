    ...
    <>
      <section className="bg-[#f6f7f8] min-h-screen">
        <div className="bg-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 py-5 flex items-center gap-2 text-xs" style={{ fontFamily: "'DM Mono', monospace" }}>
            <Link to="/" className="text-gray-500 hover:text-[#1a3a5c] transition-colors">Início</Link>
            <ChevronRight className="w-3 h-3 text-gray-300" />
            <Link to="/produtos" className="text-gray-500 hover:text-[#1a3a5c] transition-colors">Produtos</Link>
            <ChevronRight className="w-3 h-3 text-gray-300" />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
          ...
          >
            ...
            <span className="text-xs tracking-[0.15em] uppercase" style={{ fontFamily: "'DM Mono', monospace" }}>Voltar</span>
          </motion.button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <div className="bg-gradient-to-br from-[#001e38] to-[#002f5a] rounded-xl overflow-hidden relative h-[460px] flex items-center justify-center">
                ...
                <span className="absolute top-5 left-5 bg-[#f5a623] text-[#002444] px-3 py-1.5 rounded text-[8px] tracking-[0.2em] uppercase font-bold" style={{ fontFamily: "'DM Mono', monospace" }}>
                  {product.subtitle}
                </span>
                <div className="absolute bottom-5 left-5 right-5 bg-black/50 backdrop-blur-md rounded-lg p-4 border border-white/10">
                  <p className="text-white text-[11px] font-bold tracking-[0.06em] uppercase mb-1">Imagem ilustrativa</p>
                  <p className="text-white/50 text-[11px]">Equipamento pode variar conforme configuração</p>
                </div>
                <img
                  src={product.image}
                  alt={product.name}
            ...
            >
              <div className="mb-4">
                <span className="text-[#f5a623] text-xs tracking-[0.28em] uppercase" style={{ fontFamily: "'DM Mono', monospace" }}>
                  Solução Pondus
                </span>
              </div>

              <h1 className="text-5xl md:text-6xl lg:text-7xl text-[#1a3a5c] mb-2 leading-none tracking-tight" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.02em" }}>
                {product.name}
              </h1>
              <h2 className="text-4xl md:text-5xl lg:text-5xl text-[#f5a623] mb-8 leading-none" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.02em" }}>
                {product.subtitle}
              </h2>
              ...
              <div className="flex gap-4 mb-12">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 border border-[#1a3a5c]/20 text-[#1a3a5c] px-8 py-4 rounded text-xs tracking-[0.2em] uppercase hover:bg-[#1a3a5c] hover:text-white transition-all"
                  style={{ fontFamily: "'DM Mono', monospace" }}
                >
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              {product.specs.map((spec, index) => (
                ...
                >
                  <spec.icon className={`w-5 h-5 mb-4 ${index === 1 ? 'text-[#f5a623]' : 'text-[#f5a623]'}`} />
                  <p className={`font-bold text-3xl mb-2 ${index === 1 ? 'text-[#f5a623]' : 'text-[#1a3a5c]'}`} style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.03em" }}>
                    {spec.value}
                  </p>
                  <p className={`text-[11px] font-semibold tracking-[0.1em] uppercase ${index === 1 ? 'text-white/40' : 'text-gray-500'}`} style={{ fontFamily: "'DM Mono', monospace" }}>
                    {spec.label}
                  </p>
                </motion.div>
              ))}
        ...
        <div className="py-16">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                <h3 className="text-2xl text-[#1a3a5c] mb-8 tracking-tight" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase" }}>
                  Características
                </h3>
                <div className="border-t border-[#1a3a5c]/10">
                  {product.features.map((feature, index) => (
                    ...
                    >
                      <span className="text-[#f5a623] text-xs pt-1 w-6" style={{ fontFamily: "'DM Mono', monospace" }}>
                        {String(index + 1).padStart(2, '0')}
                      </span>
                      <div>
                        <h4 className="text-base font-bold text-[#1a3a5c] mb-2" style={{ fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: "0.06em", textTransform: "uppercase" }}>
                          {feature.title}
                        </h4>
              ...
              >
                <h3 className="text-base font-bold text-white mb-5" style={{ fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: "0.08em", textTransform: "uppercase" }}>
              ...
              {product.relatedProducts.map((relId) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-[8px] text-[#f5a623] tracking-[0.18em] uppercase mb-1" style={{ fontFamily: "'DM Mono', monospace" }}>
                      {data.subtitle}
                    </p>
                    <p className="text-sm font-bold text-[#1a3a5c]" style={{ fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: "0.05em", textTransform: "uppercase" }}>
                      {data.name}
                    </p>
                  </motion.div>
                );
